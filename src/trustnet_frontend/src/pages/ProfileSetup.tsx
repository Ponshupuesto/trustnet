...
//import { trustnet_backend } from '../../../declarations/trustnet_backend';
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await actor.addUser(
                ...
                [profileData.showTwitter],
                [profileData.showLinkedin],
                [profileData.showGithub],

                [profileData.allowMessages],
                [], // photo → aquí podrías cargar una imagen y pasarla como Uint8Array en lugar de []
                []  // offeredServices → por ejemplo: ["Tours", "Guía"] sería: [offeredServicesArray]
            );
